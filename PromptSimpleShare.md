...
- **Inicio**: Não tendo ./server.js ainda indica projeto novo, criar pasta copiando este (`.md`) como PROMPT.md para inicio do projeto lá. E inicie. Se você escolheu um nome de pasta que ja existe, crie outra.
...
- Regex: para rever nomes invalidos que podem bugar, exemplo: `name.replace(/[^a-zA-Z0-9_-]/g, '_').slice(0, 100)`
- Remove: `/\:*?"<>|`, `../`, `..\\`
